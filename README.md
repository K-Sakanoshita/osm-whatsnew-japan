...
- `index.html` に都道府県ミニマップ、都道府県境界、期間・間隔指定のタイムスケール、再生・停止、共有URL、CSVダウンロード、地物の新規／更新凡例を追加しました。
...
- カテゴリ／マーカー定義へ `noexit=yes`、`ford=yes`、釣具店用アイコンを追加し、定義ファイルの通常キャッシュを維持しました。
