  ...
  const dialog = window.OSMModal.createDialog({
    ...
    content: `
      ...
      <div class="app-modal-body">
        ...
        <section class="map-guide-about" aria-label="運営情報、ソースコードとライセンス"><p class="map-guide-about-description">このWebフロントエンドのソースコードをGitHubで公開しています。</p><a class="site-info-repository map-guide-repository" href="https://github.com/armd-02/osm-whatsnew-japan" target="_blank" rel="noopener noreferrer"><span>GitHubでソースコードを見る</span><small>armd-02/osm-whatsnew-japan ↗</small></a><p class="map-guide-license">OpenStreetMapのデータはOpen Database License（ODbL）の下で提供されています。利用時は© OpenStreetMap contributorsの表示が必要です。</p><p class="map-guide-operator"><a href="https://k-sakanoshita.github.io/MyPortfolio/" target="_blank" rel="noopener noreferrer">制作・運営：坂ノ下 勝幸<span class="visually-hidden">（ポートフォリオを新しいタブで開く）</span></a><br>本サイトは個人が開発・運営しています。自分をプロフィール集計から除外してほしい場合はご連絡ください。</p><p class="map-guide-disclaimer">OpenStreetMap FoundationおよびOpenStreetMap Foundation Japanの公式サービスではありません。</p></section>
      </div>
